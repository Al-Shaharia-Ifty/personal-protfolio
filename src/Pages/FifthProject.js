...
import pro1 from "../assets/project/5-1.png";
import pro2 from "../assets/project/5-2.png";
import pro3 from "../assets/project/5-3.png";
        ...
        <h2 className="min-h-screen mx-10">
          ...
          <div className="mt-10 flex gap-3 ">
            <a
              ...
              target={"_blank"}
              rel="noreferrer"
              href="https://magical-crisp-65a671.netlify.app/"
            >
          ...
          <div>
            ...
            <div className="flex items-center">
              ...
              <p className="text-xl m-0 pl-2">
                Online Doctor Service base website
              </p>
            </div>
            <div className="flex items-center">
              <svg
