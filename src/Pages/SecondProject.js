...
import pro1 from "../assets/project/2-1.png";
import pro2 from "../assets/project/2-2.png";
import pro3 from "../assets/project/2-3.png";
        ...
        <h2 className="min-h-screen mx-10">
          ...
          <div className="mt-10 flex gap-3 ">
            <a
              ...
              target={"_blank"}
              rel="noreferrer"
              href="https://puredigimate.web.app/"
            >
            ...
            <a
              ...
              target={"_blank"}
              rel="noreferrer"
              href="https://github.com/Al-Shaharia-Ifty/digimate-client"
            >
            ...
            <a
              ...
              target={"_blank"}
              rel="noreferrer"
              href="https://github.com/Al-Shaharia-Ifty/digimart-server"
            >
          ...
          <div>
            ...
            <div className="flex items-center">
              ...
              <p className="text-xl m-0 pl-2">Online store base website</p>
            </div>
            <div className="flex items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-xl m-0 pl-2">
                User can buy product in real life
              </p>
            </div>
            <div className="flex items-center">
              <svg
