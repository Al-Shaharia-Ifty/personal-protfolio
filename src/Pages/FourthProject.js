...
import pro1 from "../assets/project/4-1.png";
import pro2 from "../assets/project/4-2.png";
import pro3 from "../assets/project/4-3.png";
        ...
        <h2 className="min-h-screen mx-10">
          ...
          <div className="mt-10 flex gap-3 ">
            <a
              ...
              target={"_blank"}
              rel="noreferrer"
              href="https://genius-car-services-67edf.web.app/"
            >
            ...
            <a
              ...
              target={"_blank"}
              rel="noreferrer"
              href="https://github.com/nazruldigital/genius-car-service-client"
            >
          ...
          <div>
            ...
            <div className="flex items-center">
              ...
              <p className="text-xl m-0 pl-2">
                Online Car Service base website
              </p>
            </div>
            <div className="flex items-center">
              <svg
              ...
              <p className="text-xl m-0 pl-2">
                User can use scrvice product in real life
              </p>
            </div>
            <div className="flex items-center">
              <svg
